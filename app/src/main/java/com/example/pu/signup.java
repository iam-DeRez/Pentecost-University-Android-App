...
public class signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmailSP = findViewById(R.id.signUp_emailAddress_box);
        PasswordSP = findViewById(R.id.signUp_userPassword_box);
        PasswordSP2 = findViewById(R.id.signUp_userPassword_box2);
